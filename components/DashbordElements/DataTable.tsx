    ...
    for (let j in col) {
      ...
      loopArray.push(
        col[j] == "active" || col[j] == "ACTIVE" ?
          <td key={j} className="py-4 m-20 px-6 font-medium text-gray-900 text-center">
            <img src={'https://cdn-icons-png.flaticon.com/512/4315/4315445.png'} className="px-4" />
            {col[j]}
          </td> : col[j] == "OBSOLETE" ?
            <>
            ...
            : col[j] == "PREVIEW" ?
              < td key={j} className="py-4 px-6 font-medium text-gray-900 text-center" >
                <img src={'https://cdn-icons-png.flaticon.com/512/3840/3840662.png'} className="px-4" />
                {col[j]}
